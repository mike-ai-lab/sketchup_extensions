    ...
    >
      ...
      <section className="h-screen w-full flex items-center justify-center snap-center">
        <div className="w-full max-w-4xl relative px-4">
          <motion.div 
            className="overflow-visible rounded-[2.5rem] cursor-grab active:cursor-grabbing preserve-3d"
          ...
          >
            ...
            >
              {featuredTools.map((tool, index) => {
                ...
                return (
                  <div key={index} className="w-full flex-shrink-0 p-4 preserve-3d">
                    <motion.div 
                    ...
                    >
                      ...
                      <div className="relative z-10 preserve-3d">
                        ...
                        >
                          ...
                          <span className="text-sm font-black uppercase tracking-[0.3em]">Module Entry {index + 1}</span>
                        </motion.div>
                        ...
                        <motion.div animate={{ x: (depthFactor * -160) - dragFactor * 1.5, z: 150 }}>
                          <Link href={tool.path}>
                            <button className={`group px-12 py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all hover:scale-110 active:scale-95 shadow-2xl ${isLightBg ? 'bg-black text-white' : 'bg-white text-black'}`}>
                              Initialize Engine <ArrowRight className="ml-3 w-5 h-5 group-hover:translate-x-2 transition-transform" />
                            </button>
                          </Link>
                        </motion.div>
                      </div>
          ...
          {/* Navigation UI */}
          <div className="absolute top-1/2 -translate-y-1/2 -left-20 -right-20 flex justify-between pointer-events-none hidden lg:flex">
      ...
      {/* Footer (Part of CTA snap or separate) */}
