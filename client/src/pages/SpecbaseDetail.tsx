  ...
  return (
    <div className="bg-[#050505] min-h-screen text-white font-sans selection:bg-indigo-600 overflow-x-hidden">
      <nav className="fixed top-0 w-full z-50 p-8 flex justify-between items-center bg-[#050505]/80 backdrop-blur-xl border-b border-white/5">
        <Link href="/tools" className="flex items-center gap-4 text-[10px] font-black tracking-[0.4em] text-white/30 hover:text-indigo-500 transition-colors uppercase group">
          <ChevronLeft size={16} className="group-hover:-translate-x-2 transition-transform" /> Back
        </Link>
        <div className="text-sm font-black tracking-[0.8em] italic opacity-20">MODULE // SPEC</div>
