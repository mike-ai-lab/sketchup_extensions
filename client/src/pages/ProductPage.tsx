    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-50 to-white">
      ...
      <nav className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/">
            <a className="text-2xl font-bold text-slate-900">
              SketchUp Extensions
            </a>
          </Link>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4">
                {extension.trialDays}-Day Free Trial
              </Badge>
      ...
      <section className="py-20 px-4 bg-blue-600 text-white">
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <p className="text-xl mb-8 opacity-90">
            Try {extension.name} free for {extension.trialDays} days. No credit
            card required.
          </p>
          <Link href={`/purchase/${extension.slug}`}>
            <a>
      ...
      <footer className="py-8 px-4 bg-slate-900 text-slate-400">
        <div className="container mx-auto text-center">
          <p className="mb-2">
            © 2025 SketchUp Extensions. All rights reserved.
          </p>
