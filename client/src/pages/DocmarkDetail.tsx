        ...
        <footer className="bg-[#0c0c0e] border border-white/5 rounded-full px-12 py-6 shadow-2xl">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="/privacy-policy.html" target="_blank" rel="noopener noreferrer" className="text-[9px] font-black tracking-[0.4em] text-white/20 uppercase hover:text-purple-500 transition-colors">
                Privacy Policy
              </a>
              <div className="w-px h-3 bg-white/10"></div>
              <a href="/terms-of-service.html" target="_blank" rel="noopener noreferrer" className="text-[9px] font-black tracking-[0.4em] text-white/20 uppercase hover:text-purple-500 transition-colors">
                Terms of Service
              </a>
            </div>
          </div>
